...
const ConfigCard = ({ item, scrollYProgress }) => {
  // Hooks are now called at the top level of this sub-component, which is legal
  ...
  return (
    ...
    >
      ...
      <div className="px-14 bg-[#5b3d2e] p-4 md:p-6 flex justify-center">
        <button className=" w-full md:w-auto border border-white text-white px-6 py-2.5 md:py-3 rounded-full text-sm md:text-base font-medium hover:bg-white hover:text-[#5b3d2e] transition-all duration-300">
          UNLOCK PRICE
        </button>
      </div>
    </motion.div>
...
export default function Configurations() {
  ...
  const items = [
    { title: "3 BHK TYPE 1", size: "1753 SQ.FT" },
    { title: "3 BHK TYPE 2", size: "1763 SQ.FT" },
    { title: "3 BHK TYPE 3", size: "2552 SQ.FT" },
  ];
    ...
    >
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 w-full">
          {items.map((item, i) => (
            // Pass the scroll progress to the sub-component
